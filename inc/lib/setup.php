...
if ( current_user_can( 'edit_posts' ) || current_user_can( 'edit_pages' ) ) {
	...
	} elseif ( ( defined( 'WPB_VC_VERSION' ) && ( ( is_admin() && ( 'post.php' == $GLOBALS['pagenow'] || 'post-new.php' == $GLOBALS['pagenow'] || porto_is_ajax() ) ) || ( isset( $_REQUEST['vc_editable'] ) && $_REQUEST['vc_editable'] ) ) ) ||
